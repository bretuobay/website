export const ELIXIR_CONSULTING_DATA = {
  ...
  project_desc: [
    {
      ...
      body: 'Project management, design discovery, UX/UI, and engineering.'
    },
    {
      logo: 'staff-aug.svg',
      header: 'Staff augmentation',
      body: 'Extra horsepower to meet your project deadline.'
    },
    {
  ...
  proof: {
    ...
    items: [
      ...
      },
      {
        ...
        body: `We’re very proud of the work we’ve done with well known
  ...
  blog_header: 'OUR Elixir/Phoenix KNOWLEDGE'
};
